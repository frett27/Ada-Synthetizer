...
package body Synth.Synthetizer is
   ...
   protected body Voices_Type is
      ...
      function Can_Be_Stopped (V : Voice) return Boolean is
         ...
         ORef: Oscillators.Oscillator_Reference := VSA.Oscillator;
      begin
         return Oscillators.Can_Be_Stopped(Oref.all);
      end Can_Be_Stopped;
   ...
   begin
      ...
      SST.Voices.Allocate_New_Voice (Voice_Structure_Type'(
                                     Oscillator =>
                                       new Synth.Oscillators.Wav_Oscillator_Type'(Note_Play_Frequency     => Frequency,
                                                                    Play_Sample             => S,
